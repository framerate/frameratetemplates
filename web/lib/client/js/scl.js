/* jshint newcap: false, unused: true */
...
(function() {
    ...
    ///////////////////////////////
    // get a pretty formatted date
    scl.getFormattedDate = function()
    {
        var datemap = {
            'day' : {
                0: 'Sun',
    ...
    scl.getRandomNumber = function(min, max)
    {
    ...
    ///////////////////////////////
    // Helper function to check if the user is on a mobile browser
    // source: stackoverflow
    // @TODO - rewrite this for optimal use cases
    scl.isMobile = function()
    {
        var check = false;
